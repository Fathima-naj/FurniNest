...
// //   }
// //   return (
// //     <div className="h-screen bg-gray-600 text-white flex flex-col sticky top-0 left-0 sm:w-40 md:w-56 transition-all duration-300">
// //       {isMenuOpen ? (
// //               <HiX
// //                 size={23}
...
//       <div className="sm:hidden bg-gray-600 text-white flex justify-between items-center px-4 py-2">
...
//         } sm:block h-full bg-gray-600 text-white sm:w-40 md:w-56 flex flex-col fixed sm:sticky top-0 left-0 transition-all duration-300`}
//       >
//         <h2 className="text-2xl font-bold text-center py-6 border-b border-gray-700">
//           FurniNest
//         </h2>
